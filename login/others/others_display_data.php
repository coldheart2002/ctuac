...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            button.addEventListener('click', () => {
                window.location.href = '../admin/admin_display_data.php';
            });
        });
    </script>
...
<th>ID Status</th>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<td>' . $counter . '</td>';
            echo '<td>' . strtoupper($row['name']) . '</td>'; // Transform to uppercase
            echo '<td>' . $row['id'] . '</td>';
            echo '<td>' . $row['contact'] . '</td>';
            echo '<td>' . strtoupper($row['gname']) . '</td>'; // Transform to uppercase
            echo '<td>' . $row['course'] . '</td>';
            echo '<td>' . $row['blood'] . '</td>';
            echo '<td>' . $row['bday'] . '</td>';
            echo '<td>' . strtoupper($row['id_status']) . '</td>'; // Transform to uppercase
            echo '</tr>';
